...
// MEDIUM CRAWLER MAIN
// =====================================================
// Mô tả: Entry point cho Medium crawler
// Chạy liên tục, crawl mỗi X phút
// Cách chạy: go run cmd/crawler/medium/main.go
// =====================================================
...
const (
	...
	CrawlInterval = 10 * time.Minute // Crawl mỗi 10 phút
	PostsPerTopic = 10                // Fetch tối đa 10 posts per topic
)

func main() {
	fmt.Println("╔════════════════════════════════════════════════════════════╗")
	fmt.Println("║     MEDIUM CRAWLER                                         ║")
	fmt.Println("║     Crawl từ 5 topics mỗi 10 phút                          ║")
	fmt.Println("╚════════════════════════════════════════════════════════════╝")
	fmt.Println()
	...
	// ====== BƯỚC 4: Tạo Medium Crawler ======
	mediumCrawler := crawler.NewMediumCrawler(baseCrawler, PostsPerTopic)

	// ====== BƯỚC 5: Chạy crawl loop ======
	fmt.Println("🚀 Bắt đầu crawling...")
	fmt.Printf("   Interval: %v, Limit: %d posts/topic\n", CrawlInterval, PostsPerTopic)
	...
	fmt.Println("╔════════════════════════════════════════════════════════════╗")
	fmt.Println("║              MEDIUM CRAWLER KẾT QUẢ                        ║")
	fmt.Println("╠════════════════════════════════════════════════════════════╣")
