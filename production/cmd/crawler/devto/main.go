...
// DEV.TO CRAWLER MAIN
// =====================================================
// Mô tả: Entry point cho Dev.to crawler
// Chạy liên tục, crawl mỗi X phút
// Cách chạy: go run cmd/crawler/devto/main.go
// =====================================================
...
const (
	...
	PostsPerTag   = 6                 // Fetch tối đa 6 posts per tag
)

func main() {
	fmt.Println("╔════════════════════════════════════════════════════════════╗")
	fmt.Println("║     DEV.TO CRAWLER                                         ║")
	fmt.Println("║     Crawl từ 5 tags mỗi 10 phút                            ║")
	fmt.Println("╚════════════════════════════════════════════════════════════╝")
	fmt.Println()
	...
	// ====== BƯỚC 4: Tạo DevTo Crawler ======
	devtoCrawler := crawler.NewDevToCrawler(baseCrawler, PostsPerTag)

	// ====== BƯỚC 5: Chạy crawl loop ======
	fmt.Println("🚀 Bắt đầu crawling...")
	fmt.Printf("   Interval: %v, Limit: %d posts/tag\n", CrawlInterval, PostsPerTag)
	...
	fmt.Println("╔════════════════════════════════════════════════════════════╗")
	fmt.Println("║              DEV.TO CRAWLER KẾT QUẢ                        ║")
	fmt.Println("╠════════════════════════════════════════════════════════════╣")
